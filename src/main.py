...
def _run_agent_chat_loop(
    ...
    *,
    ...
    output_func("Tip: paste multi-line text freely — press Enter on an empty line to send.")
    ...
    while True:
        if first_prompt is not None:
            ...
            try:
                ...
                return 130
            # Slash commands and empty input submit immediately.
            # All other input collects lines until an empty line or Ctrl+D,
            # so pasted multi-line text arrives as a single message.
